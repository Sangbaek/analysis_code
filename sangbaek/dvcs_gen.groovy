        ...
        if (DVCS.KineCuts_xcG(xB, Q2, W, ele, gam) || (event.mc_status && gam.e()>0.4)){
          ...
          if (DVCS.ExclCuts_xcG(gam, ele, VMISS, VmissP, VmissG, Vhadr, Vhad2)){
            ...
            if (number_of_photons>1){
              ...
              def t_pi0 = (M*Q2+2*M*nu*nu-2*M*Math.sqrt(nu*nu+Q2)*Math.sqrt(pi0.e()*pi0.e()-Mpi0*Mpi0)*costheta2)/(M+nu)
              ...
              if (pi0.mass()<0.2 && pi0.mass()>0.08)  {
                ...
                if (pi0.mass()<0.2 && pi0.mass()>0.08)  {
                  ...
                  t_pi0 = (M*Q2+2*M*nu*nu-2*M*Math.sqrt(nu*nu+Q2)*Math.sqrt(pi0.e()*pi0.e()-Mpi0*Mpi0)*costheta2)/(M+nu)
