          ...
          if (DVCS.ExclCuts(gam, ele, VMISS, VmissP, VmissG, Vhadr, Vhad2)){
            ...
            if (number_of_photons>1){
              ...
              if (pi0.mass()<0.2 && pi0.mass()>0.08)  {
                ...
                hists.computeIfAbsent("/dvcs/pi0/after_corr/kin_corr/h_gam_energy_corr_diff_4vec", h_gam_energy_corr_diff).fill(pi0.e(), nu + t/2/M)
                hists.computeIfAbsent("/dvcs/pi0/after_corr/kin_corr/h_gam_energy_corr_diff_virtual", h_gam_energy_corr_diff).fill(pi0.e(), nu + t_pi0/2/M)
